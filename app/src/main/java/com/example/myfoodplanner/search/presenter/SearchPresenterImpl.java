package com.example.myfoodplanner.search.presenter;
...
import com.example.myfoodplanner.search.view.SearchView;
...
public class SearchPresenterImpl implements SearchPresenter {
    ...
    public SearchPresenterImpl(SearchView view, Repository repo){
        this.view = view;
        this.repo = repo;
    }
    @Override
